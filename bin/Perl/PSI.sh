...
function CountInclusion {
	...
	[ -f ${prefix}_exonic_parts.gff ] || awk '{OFS="\t"}{if ($3 == "exonic_part") print  $1,$2,$3,$4,$5,$6,$7,$8,$10":"$14}' $annotation | sed 's@[";]@@g' > ${prefix}_exonic_parts.gff
	
	## counting the exon coverage  sort based on exon ID 
	coverageBed -split -b $reads -a ${prefix}_exonic_parts.gff | awk 'BEGIN{OFS = "\t"}{ print $1,$4,$5,$5-$4+1,$9,$10 }' | sort -k 5 > ${prefix}_exonic_parts.inclusion
