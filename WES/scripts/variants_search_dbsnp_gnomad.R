...
##################### read data
variants_sample=read.table(file_out_variants_sample,header=F,stringsAsFactors=F,sep="\t",fill=T)
names(variants_sample)=c("CHROM","POS","REF","ALT","TYPE","gene","mutation_type","ensembl_ID","AAC","DP","AD","AF","IMPACT","Variant_Type","SIFT","PolyPhen")
